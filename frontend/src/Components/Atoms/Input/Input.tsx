...
import { Container, StyledImage, StyledImageContainer, StyledInput } from './Input.styles'

const link =
    'https://icdn.lenta.ru/images/2019/12/09/12/20191209124207243/square_320_483be77face892f812d0bf4ed11d2fae.jpg'

export const Input = memo(({ onChange, value, type, ...rest }: IProps) => {
